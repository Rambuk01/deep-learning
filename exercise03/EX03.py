    ...
    for n in range(0, 1000, 100):
        ...
        for epoch in range(num_epochs):
            ...
            for inputs, targets in train_loader:
                ...
                l1_norm_fc2 = torch.norm(model.fc2.weight, p=lnorm)  # Calculate L1 norm of the weights in the 2nd layer
                loss += lamb * l1_norm_fc2  # Add L1 regularization to the loss
        ...
        plt.savefig(f'exercise03/l{lnorm}-{lamb}.png')
        # plt.show()